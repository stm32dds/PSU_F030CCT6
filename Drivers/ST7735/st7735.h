...
/********************************************************************************
 * Sources and licensed from:													*
 * 		https://github.com/taburyak/ST7735_SPI_STM32_HAL Revision:f28f934		*
 * Adapted and linked to current project by:									*
 * Ivan Ivanov, Ruse, Bulgaria													*
 ********************************************************************************/
...
#define	COLOR		   uint16_t		//The type of the color
